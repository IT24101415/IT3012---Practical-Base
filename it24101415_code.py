...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None):
        ...
        # Step 2.1: Toxic trap hazard set, hidden from the agent's percept on purpose
    ...
    def get_percept(self) -> dict:
        return {
            ...
            # Step 2.2: new sensor exposing the toxin danger at the agent's current tile
    ...
    def execute_action(self, action: str):
        ...
        # Step 2.3: severe penalty for stepping on a toxic trap
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            # Diamond shape to visually distinguish traps from food/opponents
            mid_x = (x1 + x2) / 2
            mid_y = (y1 + y2) / 2
